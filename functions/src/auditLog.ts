...
export type AuditAction = 'library.created' | 'library.updated' | 'library.deleted' | 'account.deleted'
...
export const auditLog = onDocumentWritten('library/{type}/entries/{entryId}', async (event) => {
